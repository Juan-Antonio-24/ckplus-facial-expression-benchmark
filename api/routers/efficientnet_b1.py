...
router = APIRouter(prefix="/efficientnet_b1", tags=["EfficientNet B1"])
...
model_path = BASE_DIR.parent.parent / "model" / "efficientnet_b1" / "CKPlus_EfficientNetB1_best_weights.pth"
