...
router = APIRouter(prefix="/efficientnet_b4", tags=["EfficientNet B4"])
...
model_path = BASE_DIR.parent.parent / "model" / "efficientnet_b4" / "CKPlus_EfficientNetB4_best_weights.pth"
