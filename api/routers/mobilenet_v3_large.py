...
router = APIRouter(prefix="/mobilenet_v3_large", tags=["MobileNetV3 Large"])
...
model_path = BASE_DIR.parent.parent / "model" / "mobilenet_v3_large" / "CKPlus_MobileNetV3Large_best_weights.pth"
