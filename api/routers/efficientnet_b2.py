...
router = APIRouter(prefix="/efficientnet_b2", tags=["EfficientNet B2"])
...
model_path = BASE_DIR.parent.parent / "model" / "efficientnet_b2" / "CKPlus_EfficientNetB2_best_weights.pth"
