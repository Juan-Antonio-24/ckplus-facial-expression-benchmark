...
router = APIRouter(prefix="/efficientnet_b0", tags=["EfficientNet B0"])
...
model_path = BASE_DIR.parent.parent / "model" / "efficientnet_b0" / "CKPlus_EfficientNetB0_best_weights.pth"
